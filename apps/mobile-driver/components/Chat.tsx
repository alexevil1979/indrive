/**
 * Chat Component — real-time messaging with passenger
 */
...
export function Chat({ rideId, userId, token, otherUserName = "Пассажир" }: Props) {
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>Начните диалог с пассажиром</Text>
          </View>
        }
      />
